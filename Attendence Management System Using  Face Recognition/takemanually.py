    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\Users\ASUS\OneDrive\Desktop\Attendence Management System Using  Face Recognition\UI_Image\Attendance"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'C:\Users\ASUS\OneDrive\Desktop\Attendence Management System Using  Face Recognition\UI_Image\Attendance"'
                )
